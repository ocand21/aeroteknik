            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <form id="formTambah" action="POST" @submit.prevent="simpanProduk()" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-md-12">
...
export default {
    ...
    methods: {
        loadData(){
            axios.get('/api/admin/produk/' + this.$route.params.id).then(({
                data
            }) => (this.form.fill(data)));
        },
        simpanProduk(){
            ...
            let instance = this;
            this.$Progress.start();
            axios.post('/api/admin/produk/ubah/' + this.$route.params.id, formData).then((response) => {
                if (response.status) {
                    swal(
                        'Sukses!',
